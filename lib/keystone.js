...
Keystone.prototype.addUser = function(access_token, name, password, enabled, default_project_id, domain_id, cb)
{
  var self = this;
  var request_options = {};
  var user_object = {};
  ...
  if (default_project_id)
    user_data.user.default_project_id = default_project_id;
  if (domain_id)
    user_data.user.domain_id = domain_id
